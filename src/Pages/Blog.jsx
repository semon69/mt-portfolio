...
const Blog = () => {
    ...
    return (
        <div className='space-y-10'>
            <h2 className="text-4xl text-center mb-8 font-bold italic border-b-4 lg:w-1/4 lg:mx-auto pb-3  border-b-orange-600 my-10">Blogs</h2>
            <div className='border p-5 rounded space-y-6 grid grid-cols-2 items-center gap-5'>
                <div className=''>
