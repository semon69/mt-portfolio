...
const BestProjects = () => {
    return (
        <div className='my-10'>
            <p className='text-4xl font-bold italic text-center text-orange-500 my-8 border-b-orange-600 border-b-4 lg:w-1/4 lg:mx-auto pb-3'>My Best Projects</p>
            ...
            <div className='text-center my-7'>
                <button className='border-2 px-4 py-2 rounded local-btn text-white font-bold '><Link to='/projects'>See All Projects</Link></button>
            </div>
        </div>
    );
};
