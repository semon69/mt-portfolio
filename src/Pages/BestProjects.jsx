...
const BestProjects = () => {
    return (
        <div className='my-10'>
            ...
            <div data-aos="zoom-in-down" className='grid grid-cols-1 lg:grid-cols-2 gap-5 text-white'>
                <div className='border-2 rounded shadow-white shadow-sm'>
                    ...
                    <div className='p-5'>
                        ...
                        <div className='flex justify-between'>
                            <button className='border-2 px-4 py-2 rounded bg-orange-600 hover:bg-orange-800 text-white font-bold '><a href="https://github.com/semon69/la-masia-client">Github Link</a></button>
